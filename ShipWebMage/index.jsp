...
<div class="body">
  ...
  <div class="body">
    <div class="login">
      <div id="bar1"><a id="fanhui"><%=myResourcesBundle.getString("back")%></a></div>
    ...
    <div class="body">
	  ...
	  <div class="menu" id="menu">
          <div class="content">
            <ul class="menu-one">
              <li class="firstChild">
                <div class="header"><span class="txt" ><%=myResourcesBundle.getString("myFleet")%></span><span class="txt"></span><span class="arrow"> </span></div>
                <ul class="menu-two" id="shiplist">
                </ul>
              </li>
              <li >
                <div class="header"> <span class="txt" ><%=myResourcesBundle.getString("fleetMag")%></span> <span class="arrow"> </span> </div>
                <ul class="menu-two">
                  <li class="firstChild"><a id="addshipclick" class="click" ><%=myResourcesBundle.getString("addShip")%></a></li>
                  <li><a id="getshiplist" class="click" ><%=myResourcesBundle.getString("shipList")%></a></li>
                </ul>
              </li>
            </ul>
          </div>
      ...
      <div class="sheet" id="sheet">
        <div class="sheetbody" id="canvasDiv"> </div>
      </div>
      ...
      <div class="shipbar" id="shipbar">
        <div id="showshiplist" >
          <table class="gridtable" id="tab1" border="1"
          ...
          <div id="page" class="pagination"></div>
            <tr>
              <td><a id="shiplistqx" class="click" ><%=myResourcesBundle.getString("back")%></a></td>
            </tr>
        </div>
      </div>
